    ...
    <div className="p-8 max-w-7xl mx-auto relative">
      ...
      <div className="relative mb-12">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <h1
            className="text-5xl font-serif font-extrabold mb-4 text-center p-2 rounded-lg"
            style={{ color: 'white' }} 
          >
            Our Events
          </h1>
      ...
      <div className="relative mb-8">
        <div className="flex items-center justify-between">
          <h2 className="text-4xl font-serif font-semibold mb-8 text-gray-900">Seminars</h2>
          <button
            onClick={toggleFilterVisibility}
            className="px-4 py-2 bg-zinc-500 text-white rounded-lg shadow-md"
          >
        ...
        <div className='mb-24'>
          <div className='flex flex-col md:flex-row items-start md:space-x-8 mb-16'>
            <img 
              src={sem1} 
              alt="Seminar 1 pic" 
              className='rounded-lg shadow-lg w-full md:w-1/3 h-64 object-cover transform hover:scale-105 transition-transform duration-300 mb-4 md:mb-0' 
            />
            <div className='bg-white rounded-lg shadow-lg p-6 flex-1'>
              <h3 className='text-3xl font-serif font-bold mb-4 text-gray-800'>Initiate with School Staff</h3>
          ...
          <div className='flex flex-col md:flex-row items-start md:space-x-8'>
            ...
            />
            <div className='bg-white rounded-lg shadow-lg p-6 flex-1'>
              <h3 className='text-3xl font-serif font-bold mb-4 text-gray-800'>Empowering Students with Tech</h3>
              <p className='text-lg font-serif text-gray-700'>
      ...
      {isRecognitionVisible && (
        <div className='mb-24'>
          <h2 className="text-4xl font-serif font-semibold mb-8 text-gray-900">Recognition</h2>
          ...
          <div className='flex flex-col md:flex-row items-start md:space-x-8'>
            ...
            />
            <div className='bg-white rounded-lg shadow-lg p-6 flex-1'>
              <h3 className='text-3xl font-serif font-bold mb-4 text-gray-800'>Efforts</h3>
              <p className='text-lg font-serif text-gray-700'>
